...
\begin{center}
    \textbf{\Huge \scshape Jayden (Jiafeng) Yu} \\ \vspace{1pt}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, C/C++, Rust, JavaScript/TypeScript, KDB/SQL, Java/Kotlin, Lisp, Bash, Lua, MIPS/ARM, R} \\
     \textbf{Tools}{: PyTorch, TensorFlow, NumPy, Pandas, Node.js, Vue.js, MongoDB, Redis, Git, Linux/FreeBSD, LLVM, AWS}
    }}\\
...
\section{Experience}
  \resumeSubHeadingListStart
      ...
      \resumeItem{In progress}
       \resumeItem{Developing a data augmentation project using \textbf{diffusion models} and \textbf{GANs} to enhance ML models \textbf{robustness}}
      \resumeItemListEnd
  ...
  \resumeSubheading
      ...
      \resumeItemListStart
      \resumeItem{Implemented the \textbf{backend development} of a performance metrics website in \textbf{JavaScript}}
      \resumeItem{Engineered \textbf{Python} scripts to automate updates to the \textbf{data processing pipeline} via \textbf{JSON} configuration files}
